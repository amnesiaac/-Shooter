...
public class Fase extends JPanel implements ActionListener {
    ...
    public void paint(Graphics g) {
        ...
        if (emJogo) {
            ...
            ImageIcon vitoria = new ImageIcon ("recursos//albert2.jpeg");
            graficos.drawImage(vitoria.getImage(), 0, 0, null);
        }else{
            ImageIcon fimJogo = new ImageIcon("recursos//albert.png");
            ...
            if (inimigos.size() == 0) {
                 if (formaMissel.intersects(formaChefe)) {
                    ...
                    if(chefe.getVida()==0){
                        ...
                        tcon = new telainicialController(tview,tnome);
                        tcon.setponto(jogador);
                    }
                }
            }
        }
